...
const FirefoxContentInterface = function(anInformationHolder) {
    ...
    const watchForPages = () => {
        ...
        const setTab = (aTab) => {
            if (aTab.url && aTab.url.includes("dcc-at-joint-dot-ax") && aTab.url.includes("settings.html")) {
            ...
            else if (aTab.url && aTab.url.includes("resource://dcc-at-joint-dot-ax") && aTab.url.includes("/data/common/prices")) {
